      ...
      <ul className="h-screen flex flex-col items-start gap-2 whitespace-nowrap max-h-[100vh]">
        ...
        <li>
          <Link className="flex items-center w-40 h-10 rounded-full hover:bg-gray-300 hover:font-bold" href="/bookmarks">
            <img className="h-6 stroke-2 w-6 ml-3 mr-4" src="/images/bookmark.svg"></img>
            Bookmarks
          </Link>
        </li>
        <li>
        ...
        <li className='flex mt-auto mb-16 ml-2'>
          <ProfilePicture/>
          <div className='mt-1 ml-1.5'>
            <h1 className='text-xs'>PlaceHolderName</h1>
            <h1 className='text-xs text-gray-400'>@Placeholder</h1>
          </div>
        </li>
      </ul>
    </nav>
